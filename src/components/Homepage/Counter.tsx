...
export default function Counter() {
  ...
  // Counter section appears earlier and smoother
  const contentOpacity = useTransform(
    scrollYProgress, 
    isLargeScreen ? [0.3, 0.5] : [0.2, 0.4], 
    [0, 1]
  );
  ...
  useEffect(() => {
    if (!inView || hasAnimatedCounters) return;
    ...
    >
      ...
      {isLargeScreen ? (
        <div className="sticky top-0 h-screen flex items-center overflow-hidden">
          ...
          {/* COUNTER SECTION - Appears earlier */}
          <motion.div
            ref={ref}
            style={{
